...
Request2::Request2(const Request2 &request) {
    this->student = request.student;
    this->removeAdd = request.removeAdd;
}

Request2::Request2(Student student_, list<pair<UcClass, UcClass *>> pairs_) {
    this->student = student_;
    this->removeAdd = pairs_;
}

list<pair<UcClass, UcClass *>> Request2::getPairs() const {
    return this->removeAdd;
}

Student Request2::getStudent() const {
    return this->student;
}

int Request2::findUc(string ucCode, vector<UcClass> ucClasses) {
...
Request2::Request2(set<Student>* students, vector<UcClass>* ucClasses, char option) {
...
bool Request2::checkRequestInput(vector<std::string> buttons, std::string option) {
    if (buttons.size() > 9) {
...
list<pair<bool, bool>> Request2::handleRequest(set<Student>* students, vector<UcClass> ucClasses) {
...
bool Request2::checkUnbalance(vector<UcClass> ucClasses, UcClass ucClass, int type)  {
